...
int main()
{ 
  Material nature_green1(1., Vec4f(0.3, 0.4, 0.1, 0.0), Vec3f(0.275, 0.522, 0.522), 34.);
  Material nature_green2(1.5, Vec4f(0.5, 0.8, 0.0, 0.8), Vec3f(0.314, 0.706, 0.596), 58.);
  Material nature_green3(1., Vec4f(0.1, 0.1, 0.5, 0.0), Vec3f(0.612, 0.859, 0.651), 10.);
  Material nature_green4(1., Vec4f(0.6, 0.3, 0.8, 0.0), Vec3f(0.871, 0.976, 0.769), 50.);
